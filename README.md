...
#  🎯 Objetivo General
 ...
 Analizar el impacto del desarrollo urbano sobre la calidad de vida y la sostenibilidad ambiental en Latinoamérica

##  🎯 Objetivos especificos 
Para desglosar este análisis, la investigación se fundamenta en tres pilares:

- Describir el comportamiento de los indicadores "Superficie forestal", "Esperanza de vida" y "Mortalidad infantil" en latinoamerica través de los años.
   
- Determinar la correlación entre el crecimiento poblacional y la variación de la superficie forestal en los países de la región.
   
- Analizar la relación entre la esperanza de vida al nacer y las emisiones de CO2.
...
# 🔍 Marco Teórico
   ...
   El bienestar humano, medido a través de la esperanza de vida, presenta una relación compleja con el progreso:
- El Impulso Inicial: La industrialización mejora la salud al generar riqueza y servicios.
- El Punto de Inflexión: Según la Curva de Kuznets (Grossman y Krueger), llega un momento donde el daño ambiental por CO2 es tan alto que empieza a anular los beneficios ganados, afectando la longevidad de la población (Akbar et al.).
